"""
pages/dashboard.py — Project Photon: Decision Intelligence Cockpit
"""
...
def _build_business_explanation(
    ...
    constraint, outcome = _context.get(
        top_dim, ("balanced performance profile", f"optimizing the {amount} transaction")
    )
    ...
    st.markdown(
        ...
        <div style='background:#0D0F14;border:1px solid #1F2333;border-radius:10px;
          ...
          <div style='margin-top:12px;padding-top:10px;border-top:1px solid #1F2333;
            ...
            that no classical optimization algorithm can replicate.
          </div>
        </div>
        """,
        unsafe_allow_html=True,
    ...
    <div style='display:flex;gap:12px;margin-top:18px;'>
      ...
      <div style='flex:1;background:#13161E;border:1px solid #1F2333;
        ...
        <div style='font-size:0.78rem;color:#A0AACC;line-height:1.55;'>
          ...
          variational block, optimizable via gradient descent through the
      ...
      <div style='flex:1;background:#13161E;border:1px solid #1F2333;
        ...
        <div style='font-size:0.78rem;color:#A0AACC;line-height:1.55;'>
          ...
          expectation values ∈ [−1,&thinsp;1], normalized to Photon Match Scores
          [0–100] per route.</div>
      </div>
    </div>
    """,
